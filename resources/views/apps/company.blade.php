                                    ...
                                    <ul class="nav nav-pills nav-fill flex-column" id="tabs-icons-text" role="tablist">
                                        ...
                                        @foreach ($separators as $separator)
                                            <li class="nav-item pb-2">
                                                <a class="nav-link mb-sm-3 mb-md-0 @if ($loop->first) active @endif" id="{{$separator['snake']."_tab"}}" data-toggle="tab" href="#{{$separator['snake']}}" role="tab" aria-controls="{{$separator['snake']}}" aria-selected="true"><i class="{{$separator['icon']}} mr-2"></i>{{ __($separator['name']) }}</a>
                                            </li>
                                        @endforeach
